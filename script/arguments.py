...
def train_args_parser():
    ...
    parser.add_argument(
        "--distributed", help="distributed", action="store_true", default=True
    )
    parser.add_argument(
...
def generate_args_parser():
    ...
    parser.add_argument(
        "--num_hidden_feature", help="num hidden features", type=int, default=128
    )
    parser.add_argument(
        "--num_latent_feature", help="num latent features", type=int, default=128
    )
    parser.add_argument("--gamma1", type=float, default=1e1)
    parser.add_argument("--gamma2", type=float, default=5e1)
    parser.add_argument(
    ...
    parser.add_argument("--temperature_factor1", type=float, default=0.1)
    parser.add_argument("--temperature_factor2", type=float, default=0.1)
